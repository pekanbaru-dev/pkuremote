	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					"border-border bg-background hover:bg-surface-container-high hover:text-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-surface-container-high aria-expanded:text-foreground",
				secondary:
					"bg-secondary text-secondary-foreground hover:bg-secondary/80 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
				ghost:
					"hover:bg-surface-container-high hover:text-foreground dark:hover:bg-muted/50 aria-expanded:bg-surface-container-high aria-expanded:text-foreground",
				destructive:
